    ...
    <div className="bg-background min-h-screen font-body text-foreground">
      <main className="container mx-auto px-4 pt-12 pb-12">
        ...
        <Link href="/dashboard" passHref>
          <Button variant="outline" size="lg" className="w-full h-20 mb-8 text-xl font-bold bg-card/50 border-border/50 shadow-lg transition-all hover:shadow-xl hover:shadow-primary/20 hover:scale-[1.01] hover:bg-card/80 text-primary justify-between px-8 group">
            Kontrol Paneli
